...
3. Deploy an app and configure ingress gateway:
```shell
curl https://raw.githubusercontent.com/jewertow/openssl-cert-gen/master/tls.sh | sh -s - --subject="app.com"
kubectl create secret tls app-tls --key=app.com.key --cert=app.com.crt
kubectl create cm app-conf --from-file=nginx.conf
kubectl label namespace default istio-injection=enabled
kubectl apply -f app.yaml
kubectl create secret tls app-tls --key=app.com.key --cert=app.com.crt -n istio-system
...
In Istio 1.14 - 1.18, the request should fail, and you should get the following output:
```
